...
class PrefixTree extends AbstractCollection<String> {
	  ...
	  private static class PrefixTreeIterator implements Iterator<String> {
	    ...
	    private native void addTree(PrefixTree tree, String prefix) /*-{
	      var suffixes = [];
	      for (var suffix in tree.@com.gmi.nordborglab.browser.client.ui.PrefixTree::suffixes) {
	      ...
	      var frame = {
	        ...
	        subtrees: tree.@com.gmi.nordborglab.browser.client.ui.PrefixTree::subtrees,
	        prefix: prefix,
	        index: 0
	      };

	      var stack = this.@com.gmi.nordborglab.browser.client.ui.PrefixTree$PrefixTreeIterator::stack;
	      stack.push(frame);
	    }-*/;
	    ...
	    private native void init() /*-{
	      this.@com.gmi.nordborglab.browser.client.ui.PrefixTree$PrefixTreeIterator::stack = [];
	    }-*/;
	    ...
	    private native String nextImpl(boolean peek) /*-{
	      var stack = this.@com.gmi.nordborglab.browser.client.ui.PrefixTree$PrefixTreeIterator::stack;
	      var safe = @com.gmi.nordborglab.browser.client.ui.PrefixTree::safe(Ljava/lang/String;)
	      var unsafe = @com.gmi.nordborglab.browser.client.ui.PrefixTree::unsafe(Ljava/lang/String;)
	        ...
	        if (frame.index < frame.suffixNames.length) {
	          ...
	          if (frame.index < frame.suffixNames.length) {
	            ...
	            for (key in frame.subtrees) {
	              ...
	              this.@com.gmi.nordborglab.browser.client.ui.PrefixTree$PrefixTreeIterator::addTree(Lcom/gmi/nordborglab/browser/client/ui/PrefixTree;Ljava/lang/String;)(subtree, target);
	            }
	          }
	  ...
	  public native boolean add(String s) /*-{
	    var suffixes =
	        this.@com.gmi.nordborglab.browser.client.ui.PrefixTree::suffixes;
	    var subtrees =
	        this.@com.gmi.nordborglab.browser.client.ui.PrefixTree::subtrees;
	    var prefixLength =
	        this.@com.gmi.nordborglab.browser.client.ui.PrefixTree::prefixLength;
	    ...
	    if (s.length <= prefixLength) {
	      var safeKey = @com.gmi.nordborglab.browser.client.ui.PrefixTree::safe(Ljava/lang/String;)(s);
	      if (suffixes.hasOwnProperty(safeKey)) {
	        return false;
	      } else {
	        // Each tree keeps a count of how large it and its children are.
	        this.@com.gmi.nordborglab.browser.client.ui.PrefixTree::size++;
	    ...
	    // Add the string to the appropriate PrefixTree.
	      ...
	      var prefix = @com.gmi.nordborglab.browser.client.ui.PrefixTree::safe(Ljava/lang/String;)(s.slice(0, prefixLength));
	      var theTree;

	      if (subtrees.hasOwnProperty(prefix)) {
	        theTree = subtrees[prefix];
	      } else {
	        theTree = @com.gmi.nordborglab.browser.client.ui.PrefixTree::createPrefixTree(I)(prefixLength << 1);
	        subtrees[prefix] = theTree;
	      }

	      var slice = s.slice(prefixLength);
	      if (theTree.@com.gmi.nordborglab.browser.client.ui.PrefixTree::add(Ljava/lang/String;)(slice)) {
	  ...
	  public native void clear() /*-{
	    this.@com.gmi.nordborglab.browser.client.ui.PrefixTree::size = 0;
	    this.@com.gmi.nordborglab.browser.client.ui.PrefixTree::subtrees = {};
	    this.@com.gmi.nordborglab.browser.client.ui.PrefixTree::suffixes = {};
	  }-*/;
	  ...
	  protected native void suggestImpl(String search, String prefix,
	    ...
	    if (search.length > prefix.length + prefixLength) {
	      var key = @com.gmi.nordborglab.browser.client.ui.PrefixTree::safe(Ljava/lang/String;)(search.slice(prefix.length, prefix.length + prefixLength));

	      // Just pick the correct subtree, if it exists, and call suggestImpl.
	      if (subtrees.hasOwnProperty(key)) {
	        var subtree = subtrees[key];
	        var target = prefix + @com.gmi.nordborglab.browser.client.ui.PrefixTree::unsafe(Ljava/lang/String;)(key);
	        subtree.@com.gmi.nordborglab.browser.client.ui.PrefixTree::suggestImpl(Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;I)(search, target, output, limit);
	      }
	    ...
	    // The answer can only exist in this tree's suffixes or subtree keys.
	     ...
	     for (var suffix in suffixes) {
	       ...
	       var target = prefix + @com.gmi.nordborglab.browser.client.ui.PrefixTree::unsafe(Ljava/lang/String;)(suffix);
	     ...
	     for (var key in subtrees) {
	       ...
	       if (target.indexOf(search) == 0) {
	         ...
	         // Otherwise, include as many answers as we can by truncating the suffix
	           ...
	           for (var suffix in subtree.@com.gmi.nordborglab.browser.client.ui.PrefixTree::suffixes) {
	             if (suffix.indexOf(':') == 0) {
	               output.@java.util.Collection::add(Ljava/lang/Object;)(target + @com.gmi.nordborglab.browser.client.ui.PrefixTree::unsafe(Ljava/lang/String;)(suffix));
	             }
	           }

	           // Give the keys of the subtree.
	           for (var subkey in subtree.@com.gmi.nordborglab.browser.client.ui.PrefixTree::subtrees) {
	             if (subkey.indexOf(':') == 0) {
	               output.@java.util.Collection::add(Ljava/lang/Object;)(target + @com.gmi.nordborglab.browser.client.ui.PrefixTree::unsafe(Ljava/lang/String;)(subkey) + "...");
	             }
	           }
	         }
	       }
