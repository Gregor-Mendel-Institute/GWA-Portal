...
public class TaxonomyDetailPresenter
	...
	private void displayStats() {
		if (stats == null)
			return;
		getView().setGeoChartData(DataTableUtils.createDataTableFromString(stats.getGeoChartData()));
		getView().setAlleleAssayData(DataTableUtils.createDataTableFromString(stats.getAlleleAssayData()));
		getView().setSampStatData(DataTableUtils.createDataTableFromString(stats.getSampStatData()));
		getView().setStockGenerationData(DataTableUtils.createDataTableFromString(stats.getStockGenerationData()));
