...
public abstract class PhaseAnimation<T> extends Animation {
    ...
    public static class DataGridPhaseAnimation<T> extends PhaseAnimation<T> {

        private final DataGrid<T> dataGrid;

        public DataGridPhaseAnimation(DataGrid<T> dataGrid, T value,
        ...
        protected T getDisplayedItem(int index) {
            return dataGrid.getVisibleItem(index);
        }
        ...
        protected Element getRowElement(int index) {
            return dataGrid.getRowElement(index);
        }
